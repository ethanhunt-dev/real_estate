    ...
    <div className="flex flex-col min-h-screen bg-surface-base">
      ...
      <section className="pt-24 pb-16 px-4 max-w-4xl mx-auto text-center relative">
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-serif hero-title font-bold text-dark mt-4 mb-6">Our Expertise</h1>
      ...
      <section className="pb-24 px-4 max-w-7xl mx-auto w-full">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-surface-1 rounded-xl overflow-hidden shadow-soft hover:shadow-md hover:-translate-y-1 transition-all duration-200 border border-border group">
            ...
            <div className="p-8">
              <h3 className="font-serif text-2xl font-bold text-dark mb-4 group-hover:text-primary transition-colors">Strategic Plotting</h3>
          ...
          <div className="bg-surface-1 rounded-xl overflow-hidden shadow-soft hover:shadow-md hover:-translate-y-1 transition-all duration-200 border border-border group">
            ...
            <div className="p-8">
              <h3 className="font-serif text-2xl font-bold text-dark mb-4 group-hover:text-primary transition-colors">Premium Construction</h3>
              <p className="text-text-secondary mb-8 leading-relaxed body-text">
          ...
          <div className="bg-surface-1 rounded-xl overflow-hidden shadow-soft hover:shadow-md hover:-translate-y-1 transition-all duration-200 border border-border group">
            ...
            <div className="p-8">
              <h3 className="font-serif text-2xl font-bold text-dark mb-4 group-hover:text-primary transition-colors">Organic Farmlands</h3>
              <p className="text-text-secondary mb-8 leading-relaxed body-text">
      ...
      {/* Ready Banner */}
      <section className="py-24 px-4 bg-surface-base border-t border-border">
          ...
          <div className="bg-primary rounded-2xl overflow-hidden relative shadow-lg">
            ...
            <div className="px-12 py-16 md:py-20 md:px-20 relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="max-w-xl text-center md:text-left">
                <h2 className="font-serif section-h2 font-bold text-white mb-4">Ready to start your journey?</h2>
                <p className="text-surface-2 body-lg">
