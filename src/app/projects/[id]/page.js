...
export default function ProjectView({ params }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface-base">
      ...
      {/* Hero Section */}
      <section className="relative w-full h-[500px] flex items-end bg-dark overflow-hidden pb-12">
        ...
        <div className="relative z-20 px-4 max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between items-end gap-6">
          ...
          {/* Left Details */}
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-success text-white text-xs font-bold rounded-full mb-4 shadow-sm border border-success">
            ...
            <h1 className="font-serif hero-title text-white font-bold mb-2 drop-shadow-md">
              Emerald Meadows Elite
            </h1>
            <div className="flex items-center text-surface-2 text-sm font-medium">
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-2/3 space-y-16">
            ...
            {/* Overview */}
            <div>
              <h2 className="font-serif section-h2 font-bold text-dark mb-6">Project Overview</h2>
              <div className="space-y-4 text-text-secondary leading-relaxed body-text">
                <p>
            ...
            {/* Amenities */}
            <div>
              <h2 className="font-serif section-h2 font-bold text-dark mb-6">World-Class Amenities</h2>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={idx} className="bg-surface-1 border border-border rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-soft hover:shadow-md transition-shadow">
                    <div className="w-12 h-12 bg-surface-2 rounded-full flex items-center justify-center mb-3 text-primary">
                    ...
                    <span className="font-semibold text-dark text-sm">{amenity.label}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Master Plan */}
            <div>
              <h2 className="font-serif section-h2 font-bold text-dark mb-6">Master Plan</h2>
              <div className="bg-surface-base p-2 rounded-xl shadow-soft border border-border">
                <div className="rounded-lg overflow-hidden aspect-[4/3] bg-[url('https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&q=80')] bg-cover bg-center">
            ...
            {/* Price List */}
            <div>
              <h2 className="font-serif section-h2 font-bold text-dark mb-6">Price List</h2>
              <div className="bg-surface-base rounded-xl shadow-soft border border-border overflow-hidden">
                <table className="w-full text-sm text-left">
                  <thead className="text-xs text-dark uppercase bg-surface-3">
                    <tr>
                  ...
                  <tbody className="divide-y divide-border">
                    <tr className="hover:bg-surface-2 transition-colors">
                      <td className="px-6 py-4 font-semibold text-dark">30' x 40'</td>
                      <td className="px-6 py-4 text-text-secondary">1200</td>
                      <td className="px-6 py-4 font-semibold text-dark">₹54 Lakhs*</td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-block px-3 py-1 bg-surface-3 text-dark text-xs font-bold rounded-full">Available</span>
                      </td>
                    </tr>
                    <tr className="hover:bg-surface-2 transition-colors">
                      <td className="px-6 py-4 font-semibold text-dark">30' x 50'</td>
                      <td className="px-6 py-4 text-text-secondary">1500</td>
                      <td className="px-6 py-4 font-semibold text-dark">₹67 Lakhs*</td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-block px-3 py-1 bg-surface-3 text-dark text-xs font-bold rounded-full">Available</span>
                      </td>
                    </tr>
                    <tr className="hover:bg-surface-2 transition-colors">
                      <td className="px-6 py-4 font-semibold text-dark">40' x 60'</td>
                      <td className="px-6 py-4 text-text-secondary">2400</td>
                      <td className="px-6 py-4 font-semibold text-dark">₹1.08 Cr*</td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-block px-3 py-1 border border-border text-text-secondary bg-surface-2 text-xs font-bold rounded-full">Selling Fast</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            {/* Location Advantage */}
            <div>
              <h2 className="font-serif section-h2 font-bold text-dark mb-6">Location Advantage</h2>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-surface-1 rounded-xl shadow-soft border border-border p-6 space-y-6">
                  {[
                    ...
                    <div key={idx} className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-dark text-sm">{loc.title}</h4>
                        <p className="text-xs text-text-secondary font-medium">{loc.time}</p>
                      </div>
                    </div>
                  ))}
                </div>
                
                <div className="bg-surface-3 rounded-xl overflow-hidden relative shadow-soft min-h-[250px]">
                   {/* Abstract Dark Map Placeholder */}
                   <div className="absolute inset-0 p-6 flex items-center justify-center">
                     <svg viewBox="0 0 200 200" className="w-full h-full opacity-60">
                        <path d="M50 100 L100 50 L150 100 L100 150 Z" stroke="var(--color-primary)" strokeWidth="1" fill="none" />
                        <path d="M20 80 L180 80" stroke="var(--color-primary)" strokeWidth="0.5" fill="none" />
                        <path d="M100 20 L100 180" stroke="var(--color-primary)" strokeWidth="0.5" fill="none" />
                        <circle cx="100" cy="100" r="4" fill="var(--color-primary)" />
                        <circle cx="50" cy="100" r="3" fill="var(--color-primary)" />
                        <circle cx="150" cy="100" r="3" fill="var(--color-primary)" />
                        <circle cx="100" cy="50" r="3" fill="var(--color-primary)" />
                        <circle cx="100" cy="150" r="3" fill="var(--color-primary)" />
                        <circle cx="120" cy="70" r="2" fill="var(--color-primary)" />
                        <circle cx="80" cy="130" r="2" fill="var(--color-primary)" />
                     </svg>
                   </div>
                </div>
              </div>
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-24 bg-surface-base rounded-xl shadow-lg p-8 border border-border">
              <h3 className="font-serif section-h2 font-bold text-dark mb-3">Schedule a Site Visit</h3>
              ...
              <form className="space-y-4 mb-8">
                <div>
                  ...
                  <input type="text" placeholder="John Doe" className="w-full px-4 py-2.5 bg-surface-base border-[1.5px] border-[#E0E0E0] rounded-md text-dark focus:outline-none focus:border-primary focus:ring-[3px] focus:ring-primary/20 text-sm transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-dark mb-1">Email Address</label>
                  <input type="email" placeholder="john@example.com" className="w-full px-4 py-2.5 bg-surface-base border-[1.5px] border-[#E0E0E0] rounded-md text-dark focus:outline-none focus:border-primary focus:ring-[3px] focus:ring-primary/20 text-sm transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-dark mb-1">Phone Number</label>
                  <input type="tel" placeholder="+91 98765 43210" className="w-full px-4 py-2.5 bg-surface-base border-[1.5px] border-[#E0E0E0] rounded-md text-dark focus:outline-none focus:border-primary focus:ring-[3px] focus:ring-primary/20 text-sm transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-dark mb-1">Message (Optional)</label>
                  <textarea placeholder="Interested in 30x40 plots..." rows="3" className="w-full px-4 py-2.5 bg-surface-base border-[1.5px] border-[#E0E0E0] rounded-md text-dark focus:outline-none focus:border-primary focus:ring-[3px] focus:ring-primary/20 text-sm resize-none transition-all"></textarea>
                </div>
                
                <button type="submit" className="w-full py-[14px] mt-2 bg-primary hover:bg-[#5A2EE0] text-white font-semibold rounded-md transition-all duration-150 shadow-soft hover:shadow-md hover:-translate-y-[2px] flex justify-center items-center gap-2 focus:outline-none focus:ring-[3px] focus:ring-primary/20">
              ...
              <div className="pt-6 border-t border-border space-y-3">
                <div className="flex items-center text-dark text-sm font-bold">
                  <svg className="w-4 h-4 mr-3 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                  +91 80 1234 5678
                </div>
                <div className="flex items-center text-dark text-sm font-bold">
                  <svg className="w-4 h-4 mr-3 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
